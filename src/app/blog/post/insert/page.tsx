    ...
    <div className="bg-white p-8 rounded shadow">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea id="content" name="content" rows={4} value={postContent} onChange={handleTextAreaChange} className="w-full border-2 border-purple-100 p-2 rounded-md focus:border-purple-200 focus:outline-none"></textarea>
